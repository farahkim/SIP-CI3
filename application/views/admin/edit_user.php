<div class="container-fluid">
	...
	<?php foreach ($user as $usr) : ?>
		...
		<form method="post" action=" <?php echo base_url(). 'admin/data_user/update_user_aksi'?>" enctype="multipart/form-data">

			<div class="for-group">
				<label>ID User</label>
				<input type="text" name="id_user" class="form-control" value="<?php echo $usr->id_user ?>">
			</div>
