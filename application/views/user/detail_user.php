		...
		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<td><?php echo anchor('user/detail_user/update_user/' .$dt->id_user,' <div class="btn btn-danger">Update</div>') ?></td>
					<td><?php echo anchor('user/dashboard/','<div class="btn btn-success">Kembali</div>') ?></td>
				</div>
